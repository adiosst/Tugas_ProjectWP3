...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="<?php echo base_url(); ?>assets2/img/logoss.png" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Perpustakaan</b>Desa</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <center>
        <a href="<?php echo base_url();?>admin/Home">
          <img src="<?php echo base_url(); ?>assets2/img/logoss.png" alt="" srcset="" width="47px">
        </a>
      </center>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url(); ?>admin/Nim"><i class="fa fa-building-o"></i>Data Profesi</a></li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong><a href="#">"Melalui perpus desa kami mendukung dan ikut mewujudkan gerakan Desa Pintar di Era Digital"</a>.</strong> 
  </footer>
