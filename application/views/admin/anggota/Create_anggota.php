...
<div class="box box-solid box-success">
	...
	<form class="form-horizontal" method="post"  action="<?php echo base_url(); ?>admin/Anggota/create" role="form">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" maxlength="15" required="required" class="form-control" name="pass" placeholder="password" >
                  </div>
                </div>
              </div>
              <div class="col-sm-4">
  ...
  <div class="box-footer">
    Menambah Data Anggota Ruang Baca Perspustakaan Desa, isi form diatas untuk menambahkan data Anggota. 
  </div><!-- box-footer -->
</div><!-- /.box -->
