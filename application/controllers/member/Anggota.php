...
class Anggota extends MY_Controller {
	...
	public function index(){
		...
		if(!empty($cek) && $stts=='member')
		{
			...
			$tmp['content']=$this->load->view('member/anggota/View_anggota',$data, TRUE);
	...
	public function create()
	{
		...
		{	
				...
				if($this->form_validation->run()==FALSE)
				{
					...
					$data['data_kelas'] = $this->Buku_model->getAllData("tb_kelas");
					$data['data_agama'] = $this->Buku_model->getAllData("tb_agama");
					$tmp['content']=$this->load->view('member/anggota/Create_anggota',$data,true);
					$this->load->view('member/layout',$tmp);
				}
			 	else
				{
					...
					if ($query)
					{
						...
						redirect("member/Anggota","refresh");	
					}
					else
					{
						$this->session->set_flashdata("message","gagal!!!");
						redirect("member/Anggota/Create_anggota","refresh");	
					}
				}
		}
		else
	...
	{ 
		...
		{		
				...
				if($this->form_validation->run()==FALSE)
				{
					...
					$data['data_kelas'] = $this->Buku_model->getAllData("tb_kelas");
					$data['data_agama'] = $this->Buku_model->getAllData("tb_agama");
					$tmp['content']=$this->load->view('member/anggota/Edit_anggota',$data,true);
					$this->load->view('member/layout',$tmp);
				}
		}
		else
