...
class Denda extends MY_Controller {
	...
	public function index(){
		...
		if(!empty($cek) && $stts=='member')
		{
			...
			$tmp['content']=$this->load->view('member/denda/View_denda',$data, TRUE);
	...
	public function create()
	{
		...
		{	
				...
				if($this->form_validation->run()==FALSE)
				{
					...
					/*data yang ditampilkan*/
					$data['data_denda'] = $this->Buku_model->getAllData("tb_denda");
					$tmp['content']=$this->load->view('member/denda/Create_denda',$data,true);
					$this->load->view('member/layout',$tmp);
				}
			 	else
				{
					...
					$query=$this->Buku_model->insertData('tb_denda',$data);
						redirect("member/Denda/index","refresh");	
	...
	{ 
		...
		{		
				...
				if($this->form_validation->run()==FALSE)
				{
					...
					$tmp['content']=$this->load->view('member/denda/Edit_denda',$data,true);
					$this->load->view('member/layout',$tmp);
				}
		}
		else
