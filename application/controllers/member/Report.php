...
class Report extends CI_Controller {
    ...
    public function index()
    {
        ...
        if(!empty($cek) && $stts=='member')
        {
            ...
            $tmp['content']=$this->load->view('member/report/View_report_buku',$data, TRUE);
     ...
     public function Pdfkan()
    {
        ...
        if(!empty($cek) && $stts=='member')
        {
            ...
            $data['data_detail_buku'] = $this->Buku_model->getAllData("tb_detail_buku");
            $data['data_buku'] = $this->Buku_model->getAllData("tb_buku");
            $this->load->view('member/report/View_report_buku_pdf',$data);
        }
        else
        {
            header('location:'.base_url().'web/log');
        ...
        public function pengembalian()
    {
        ...
        if(!empty($cek) && $stts=='member')
        {
            ...
            $data['data_buku'] = $this->Buku_model->getAllData("tb_buku");
            //$this->Buku_model->generatePdf($kolom, $data,"Laporan Data Siswa");
            $tmp['content']=$this->load->view('member/report/kembali/View_report_kembali',$data, TRUE);
            $this->load->view('member/layout',$tmp);
        }
        else
        /*jika status login NO atau status bukan admin kembalikan ke login*/
     ...
     public function pdf_kembali()
    {
        ...
        if(!empty($cek) && $stts=='member')
        {
            ...
            $data['data_detail_buku'] = $this->Buku_model->getAllData("tb_detail_buku");
            $data['data_buku'] = $this->Buku_model->getAllData("tb_buku");
            $this->load->view('member/report/kembali/View_report_kembali_pdf',$data);
        }
        else
        {
            header('location:'.base_url().'web/log');
