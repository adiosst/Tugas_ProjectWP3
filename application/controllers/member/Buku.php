...
class Buku extends MY_Controller {
	...
	public function buku()
	{
		...
		if(!empty($cek) && $stts=='member')
		{
			...
			$tmp['content']=$this->load->view('member/buku/R_buku',$data, TRUE);
	...
	public function hapus_buku()
	{
		...
		if(!empty($cek) && $stts=='member')
		{
			...
			header('location:'.base_url().'member/Buku/buku');
		}
		else
		{
			header('location:'.base_url().'web/log');
	...
	public function tambah_buku()
	{
		...
		{	
			...
			if ($this->form_validation->run() === FALSE)
			{
				...
				$data['data_rak'] = $this->Buku_model->getAllData("tb_rak");
				/*masukan data kedalam view */
				$tmp['content']=$this->load->view('member/buku/C_buku',$data, TRUE);
				$this->load->view('member/layout',$tmp);
			}
			else
			{
	...
	public function edit_buku()
	{
		...
		{	
			...
			/*layout*/	
				...
				/*masukan data kedalam view */
				$tmp['content']=$this->load->view('member/buku/U_buku',$data, TRUE);
				$this->load->view('member/layout',$tmp);		
		}
		else
		{
	...
	public function update_buku()
	{
		...
		{	
			...
			else
			{
				...
				redirect('member/Buku/Buku','refresh');
	...
	public function detail_stok(){
		...
		if(!empty($cek) && $stts=='member')
		{
			...
			/*masukan data kedalam view */
			$tmp['content']=$this->load->view('member/buku/R_detail_stok',$data, TRUE);
			$this->load->view('member/layout',$tmp);
		}
		else
		/*jika status login NO atau status bukan admin kembalikan ke login*/
	...
	public function hapus_det_buku()
	{
		...
		if(!empty($cek) && $stts=='member')
		{
            ...
            header('location:'.base_url().'member/buku/detail_stok/?id_buku='.$id_buku.'');
			}
		}
		else
		{
	...
	public function tambah_det_buku()
	{
		...
		{	
			...
			if ($this->form_validation->run() === FALSE)
			{
				...
				/*masukan data kedalam view */
				$tmp['content']=$this->load->view('member/buku/C_detail_stok',$data, TRUE);
				$this->load->view('member/layout',$tmp);
			}
			else
			{
		            ...
		            header('location:'.base_url().'member/buku/tambah_det_buku/?id_buku='.$id_buku.'');
					}
					else{
	...
	public function edit_det_buku()
	{
		...
		{	
			...
			/*layout*/	
				...
				/*masukan data kedalam view */
				$tmp['content']=$this->load->view('member/buku/U_detail_stok',$data, TRUE);
				$this->load->view('member/layout',$tmp);		
		}
		else
		{
